...
const Menubar = () => {
  ...
  return (
    ...
    <div className="container">
        <Link to="/"><img src={assets.FoodieFood} alt='' className='mx-4' height={48} width={48}/></Link>
        ...
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
            <Link className={active == "contact-us" ? "nav-link active":"nav-link"} to="/contactus" onClick={()=>setActive("contact-us")}>Contact Us</Link>
            </li>
        </ul>
